...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameBtn = findViewById(R.id.settings_name_btn);
        mInviteFriendBtn = findViewById(R.id.settings_inviteFriend_btn);
        mDeleteAccountBtn = findViewById(R.id.settings_deleteAccount_btn);
        ...
        mNameBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent name_intent = new Intent(SettingsActivity.this, NameChangeActivity.class);
        ...
        mInviteFriendBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sendIntent = new Intent(Intent.ACTION_VIEW);
                sendIntent.setData(Uri.parse("sms:"));
                sendIntent.putExtra("sms_body", "Hey!! Check this app 'WhatsApp'. This is an Awesome App.");
