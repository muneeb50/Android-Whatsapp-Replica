    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSavebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Progress
                mProgress = new ProgressDialog(NameChangeActivity.this);
                ...
                mNameDatabase.child("name").setValue(name).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            mProgress.dismiss();
                            Toast.makeText(NameChangeActivity.this,"Name Changed Succesfully",Toast.LENGTH_LONG).show();
